...
<section class="about-section" style="padding: 24px 0; border-bottom: 1px solid #e2e8f0; margin-bottom: 36px;">
  <h1 style="font-size: 2rem; font-weight: 700; color: #0f172a; margin-bottom: 8px;">
    Susan Blair
  </h1>
  <p style="font-size: 1.1rem; color: #334155; max-width: 720px; line-height: 1.6; margin-bottom: 16px;">
    Senior Application Systems Analyst &amp; Solutions Architect specializing in enterprise resource planning (ERP), HighJump WMS optimization, and 3PL integrations.
  </p>
  
  <div class="about-links" style="display: flex; gap: 12px; align-items: center;">
...
<section class="articles-section" style="margin-bottom: 48px;">
  <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 20px;">
    ...
    <span style="font-size: 0.875rem; color: #64748b;">Case Studies &amp; Solution Architecture</span>
  </div>
  ...
  <ul class="post-list" style="list-style: none; padding-left: 0; margin-left: 0;">
    ...
    {% else %}
      <li style="padding: 16px; color: #64748b; font-style: italic;">
        Articles and enterprise case studies coming soon.
      </li>
    {% endfor %}
  </ul>
</section>

<!-- 3. PROJECTS & RANDOM SECTION -->
<section class="projects-section" style="margin-bottom: 36px;">
  <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 20px;">
    <h2 style="font-size: 1.5rem; font-weight: 600; color: #0f172a; margin: 0;">
      Projects &amp; Side Pursuits
    </h2>
    <span style="font-size: 0.875rem; color: #64748b;">Tools, Concepts &amp; Creative Works</span>
  </div>
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 16px;">
    ...
    <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px;">
      <h3 style="font-size: 1.05rem; font-weight: 600; margin-top: 0; margin-bottom: 8px; color: #0f172a;">
        WMS Integration Sandbox
      </h3>
      <p style="font-size: 0.9rem; color: #475569; margin-bottom: 12px; line-height: 1.5;">
        Architectural diagrams, data mappings, and testing notes for third-party logistics integrations.
      </p>
      <a href="#" style="font-size: 0.875rem; font-weight: 600; color: #2563eb; text-decoration: none;">View Project &rarr;</a>
    </div>

    <!-- Sample Project Card 2 -->
    <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px;">
      <h3 style="font-size: 1.05rem; font-weight: 600; margin-top: 0; margin-bottom: 8px; color: #0f172a;">
        Historical Fiction Manuscripts
      </h3>
      <p style="font-size: 0.9rem; color: #475569; margin-bottom: 12px; line-height: 1.5;">
        Drafts, timeline tracking, and character developments set in the 1960s.
      </p>
      <a href="#" style="font-size: 0.875rem; font-weight: 600; color: #2563eb; text-decoration: none;">Explore Notes &rarr;</a>
    </div>
  </div>
</section>
